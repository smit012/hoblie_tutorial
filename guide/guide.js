...
function render() {
  ...
  progress.innerText = `${slide.title} – ${index + 1} / ${kit.slides.length}`;
  ...
  if (slide.type === "poll") {
    ...
    slide.options.forEach(opt => {
      ...
      btn.onclick = () => {
        // 1️⃣ Disable all options to prevent double click
...
if (slide.type === "review") {
  ...
  // ✅ Force textarea placeholder to render correctly
...
msgEl.innerText = `Show off your ${kitName} & inspire others ✨`;
...
const phone = "919016028218"; // ← PUT YOUR NUMBER HERE
